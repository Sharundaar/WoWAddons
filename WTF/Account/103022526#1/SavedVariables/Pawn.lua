...
PawnCommon = {
	...
	["Scales"] = {
		...
		["Sharundito - Beast Mastery (Raidbots)"] = {
		...
		["Sharundaar - Elemental - Patchwerk (Raidbots)"] = {
			["IconTexturePath"] = 136048,
			["PerCharacterOptions"] = {
			},
			["Color"] = "0070dd",
		...
		["Sharundito - Marksmanship (Raidbots)"] = {
			["IconTexturePath"] = 236179,
			["PerCharacterOptions"] = {
		...
		["Sharunite - Brewmaster - Patchwerk (Raidbots)"] = {
			["IconTexturePath"] = 608951,
			["Values"] = {
				["IsWand"] = -1000000,
				["Is2HMace"] = -1000000,
		...
		["Sharundaar - Enhancement (Raidbots)"] = {
